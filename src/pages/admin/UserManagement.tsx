      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
            Manage users and monitor their details.
          </p>
        </div>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-opacity-50 flex justify-center items-center z-50 bg-opacity-50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-md w-full">
              ...
              <div className="mb-4">
                ...
                <input
                  type="text"
                  className="w-full p-2 border border-gray-300 dark:text-white dark:border-gray-600 rounded-lg"
