...
const PricingPage: React.FC = () => {
  ...
  const handleStartTrial = () => {
       window.location.href = `https://buy.stripe.com/test_8x24gBeBh149a7h7Ta83C02?client_reference_id=userId`;

  };

  const handleContactSales = () => {
    window.location.href = `https://buy.stripe.com/test_4gM00lgJp9AF6V5ddu83C03`;
